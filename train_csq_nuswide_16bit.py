...
class CSQ_ResNet50(nn.Module):
    def __init__(self, bit=16, num_classes=21, pretrained_path=None):
        ...
        self.register_buffer('class_centers', get_csq_center(bit, num_classes, device=DEVICE))
...
class CSQLoss_MultiLabel(nn.Module):
    ...
    def forward(self, h, b, labels, class_centers):
        ...
        quantization_loss = F.mse_loss(torch.tanh(h), b_binary)
